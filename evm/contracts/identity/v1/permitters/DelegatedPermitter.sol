...
abstract contract DelegatedPermitter is Permitter, IPermitterProxy {
    function _grantPermit(IdentityId, address, address, bytes calldata, bytes calldata)
        internal
        virtual
        override
    ...
    function _revokePermit(IdentityId, address, address, bytes calldata, bytes calldata)
        internal
        virtual
        override
        returns (bool allow)
